...
//Mock USDT
const mockUSDTSupply = new BN(200000000).mul(new BN(10).pow(new BN(18))); //2000000USDT
...
const privatePeriodBlock = 20;
const votePeriodblock = 30;
const voteOpposeRate = 75;
const expectPrivateReserveToken = new BN(100000000).mul(new BN(10).pow(new BN(18)));
